    ...
    <div class="container mx-auto lg:w-2/3 p-5">
        ...
        <div class="bg-white rounded-lg p-3">
            <table>
                <tbody>
                <tr>
                    <td class="font-bold py-1 px-2">Commande #</td>
                    <td>{{$order->id}}</td>
                </tr>
                <tr>
                    <td class="font-bold py-1 px-2">Date de la commande</td>
                    <td>{{$order->created_at}}</td>
                </tr>
                <tr>
                    <td class="font-bold py-1 px-2">Statut de la commande</td>
                    <td>
                        <span
                ...
                <tr>
                    <td class="font-bold py-1 px-2">Sous-total</td>
                ...
                <div class="flex flex-col sm:flex-row items-center  gap-4">
                    ...
                    <div class="flex flex-col justify-between">
                        ...
                        <div class="flex justify-between items-center">
                            <div class="flex items-center">Qté: {{$item->quantity}}</div>
