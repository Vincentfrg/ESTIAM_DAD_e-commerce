<template>
    <div class="bg-white p-4 rounded-lg shadow animate-fade-in-down">
        ...
        <table class="table-auto w-full">
            <thead>
                <tr>
                    ...
                    <TableauHeaderCell @click="sortOrder('total_price')" class="border-b-2 p-2 text-left" field="total_price"
                        :sort-field="sortField" :sort-direction="sortDirection">Prix</TableauHeaderCell>
                    <TableauHeaderCell @click="sortOrder('number_of_items')" class="border-b-2 p-2 text-left"
                        field="number_of_items" :sort-field="sortField" :sort-direction="sortDirection">Produits
                    </TableauHeaderCell>
            ...
            <tbody v-else>
                <!-- <tr v-for="(Order, index) of orders.data" class="animate-fade-in-down" :style="{'animation-delay': `${index * 0.075}s`}"> -->
        ...
        <div v-if="!orders.loading" class="flex justify-between items-center mt-5">
            <span>
                Afficher de {{ orders.from }} à {{ orders.to }}
            </span>
