                        ...
                        <DialogPanel
                            ...
                            <header class="py-3 px-4 flex justify-between items-center">
                                <DialogTitle as="h3" class="text-lg font-medium leading-6 text-gray-900">
                                    {{ user.id ? `Modifier le produit: "${props.user.title}"` : 'Créer un nouveau produit'}}
                                </DialogTitle>
                                <button
                                    @click="closeModal()"
                            ...
                            <form @submit.prevent="onSubmit">
                                <div class="bg-white px-4 pt-5 pb-4">
                                    <CustomInput class="mb-2" v-model="user.title" label="Titre"/>
                                    <CustomInput type="file" class="mb-2" label="Image" @change="file => user.image = file"/>
                                    <CustomInput type="textarea" class="mb-2" v-model="user.description" label="Description"/>
                                    <CustomInput type="number" class="mb-2" v-model="user.price" label="Prix" prepend="€"/>
                                </div>
